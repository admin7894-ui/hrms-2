...
-- CreateIndex
CREATE UNIQUE INDEX "state_master_state_code_key" ON "state_master"("state_code");

-- CreateIndex
CREATE UNIQUE INDEX "state_master_state_name_country_id_key" ON "state_master"("state_name", "country_id");

-- CreateIndex
CREATE UNIQUE INDEX "city_master_city_code_key" ON "city_master"("city_code");

-- CreateIndex
CREATE UNIQUE INDEX "city_master_city_name_state_id_key" ON "city_master"("city_name", "state_id");

-- CreateIndex
CREATE UNIQUE INDEX "country_master_country_code_key" ON "country_master"("country_code");

-- CreateIndex
CREATE UNIQUE INDEX "country_master_country_name_key" ON "country_master"("country_name");
...
-- AddForeignKey
ALTER TABLE "city_master" ADD CONSTRAINT "city_master_state_id_fkey" FOREIGN KEY ("state_id") REFERENCES "state_master"("state_id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "city_master" ADD CONSTRAINT "city_master_country_id_fkey" FOREIGN KEY ("country_id") REFERENCES "country_master"("country_id") ON DELETE RESTRICT ON UPDATE CASCADE;
